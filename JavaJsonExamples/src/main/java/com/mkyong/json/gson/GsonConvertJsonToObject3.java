...
public class GsonConvertJsonToObject3 {
    ...
    public static void main(String[] args) {
        ...
        String json = "{\"name\":\"said\",\"age\":42,\"position\":" +
                "[\"Founder\",\"CTO\",\"Writer\"],\"skills\":" +
                "[\"java\",\"python\",\"node\",\"kotlin\"],\"salary\":" +
                "{\"2018\":14000,\"2012\":12000,\"2010\":10000},\"active\":true}";
        ...
        if (element.isJsonObject()) {
            ...
            //Said added his codegym email:
            obj.addProperty("email", "said.codegym@gmail.com" );
        ...
        System.out.println("el email ahora es: " + staff.getEmail());
