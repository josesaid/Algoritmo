package com.mx.josesaid.cassandra.java.client;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.mx.josesaid.cassandra.java.client.domain.Book;
import com.mx.josesaid.cassandra.java.client.repository.BookRepository;
import com.mx.josesaid.cassandra.java.client.repository.KeyspaceRepository;
...
public class CassandraClient {
    ...
    public static void main(String args[]) {
        ...
        Book book = new Book(UUIDs.timeBased(), "Effective Java", "Joshua Bloch", "Programming", "publisher1");
