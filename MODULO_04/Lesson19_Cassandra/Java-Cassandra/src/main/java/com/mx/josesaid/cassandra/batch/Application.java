package com.mx.josesaid.cassandra.batch;
...
public class Application {
    ...
    public static void main(String... argsVariables) {
        new Application().run();
    }
    ...
    public void run() {
        ...
        productRepository.createProductTableByName("testKeyspace"); // Ensure product_by_name table is created
    ...
    private Product getProduct() {
        ...
        product.setDescription("Banana description");
