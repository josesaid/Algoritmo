package com.mx.development.said.hibernate.interceptors;

import com.mx.development.said.hibernate.interceptors.entity.User;
...
public class HibernateUtil {
    ...
    private static SessionFactoryBuilder getSessionFactoryBuilder(ServiceRegistry serviceRegistry) {
        ...
        metadataSources.addPackage("com.mx.development.said.hibernate.interceptors");
