package com.mx.development.said.hibernate.namingstrategy;
...
public class NamingStrategyLiveTest {
    ...
    public void init() {
        try {
            ...
            SessionFactory factory = metadataSources
                    .buildMetadata()
                    .buildSessionFactory();
    ...
    public void testCustomPhysicalNamingStrategy() {
        ...
        Object[] result = (Object[]) session.createNativeQuery("select c.firstName, c.lastName, c.emailAddress from Customer c where c.id = :id")
            .setParameter("id", id)
            .getSingleResult();
